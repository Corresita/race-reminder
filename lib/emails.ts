...
function shell(inner: string, unsubUrl: string, kicker: string): string {
  ...
  <div style="max-width:600px;margin:0 auto;background:#f5f5f5;border:1px solid #a1a1aa;border-radius:24px;padding:36px 32px;font-family:${FONT_STACK};font-size:16px;color:#18181b;line-height:1.55;">
