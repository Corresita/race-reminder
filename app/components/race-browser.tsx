        ...
        <div className="flex w-full items-center gap-1.5 sm:ml-auto sm:w-auto">
          <span className="relative shrink-0">
            <select
              ...
              className={`cursor-pointer appearance-none rounded-full border py-1.5 pr-[29px] pl-3 text-[11px] tracking-wide uppercase transition-colors focus:outline-none ${
                activeRegion
                  ? "border-zinc-900 bg-zinc-900 text-zinc-50"
